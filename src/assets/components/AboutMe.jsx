                ...
                <div className="flex flex-wrap justify-center">
                    <div className="w-full sm:max-w-[85%] lg:max-w-[80%]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
                            ...
                            <div className="flex flex-col gap-6">
                                ...
                                >
                                    ...
                                    <div className="skill flex flex-wrap justify-center gap-4 sm:gap-6 items-center mt-6">
                                        <img src={html5} alt="html" className="w-8 sm:w-10 lg:w-12 hover:scale-125 transition-transform duration-300 cursor-pointer hover:drop-shadow-[0_0_8px_rgba(221,126,113,0.5)]" />
                                        <img src={css3} alt="css" className="w-8 sm:w-10 lg:w-12 hover:scale-125 transition-transform duration-300 cursor-pointer hover:drop-shadow-[0_0_8px_rgba(221,126,113,0.5)]" />
                                        <img src={javascript} alt="javascript" className="w-8 sm:w-10 lg:w-12 hover:scale-125 transition-transform duration-300 cursor-pointer hover:drop-shadow-[0_0_8px_rgba(221,126,113,0.5)]" />
                                        <img src={bootstrap} alt="bootstrap" className="w-8 sm:w-10 lg:w-12 hover:scale-125 transition-transform duration-300 cursor-pointer hover:drop-shadow-[0_0_8px_rgba(221,126,113,0.5)]" />
                                        <img src={tailwindcss} alt="tailwindcss" className="w-8 sm:w-10 lg:w-12 hover:scale-125 transition-transform duration-300 cursor-pointer hover:drop-shadow-[0_0_8px_rgba(221,126,113,0.5)]" />
                                        <img src={react} alt="react" className="w-8 sm:w-10 lg:w-12 hover:scale-125 transition-transform duration-300 cursor-pointer hover:drop-shadow-[0_0_8px_rgba(221,126,113,0.5)]" />
                                        <img src={typescript} alt="typescript" className="w-8 sm:w-10 lg:w-12 hover:scale-125 transition-transform duration-300 cursor-pointer hover:drop-shadow-[0_0_8px_rgba(221,126,113,0.5)]" />
                                        <img src={laravel} alt="laravel" className="w-8 sm:w-10 lg:w-12 hover:scale-125 transition-transform duration-300 cursor-pointer hover:drop-shadow-[0_0_8px_rgba(221,126,113,0.5)]" />
                                        <img src={codeigniter} alt="codeigniter" className="w-8 sm:w-10 lg:w-12 hover:scale-125 transition-transform duration-300 cursor-pointer hover:drop-shadow-[0_0_8px_rgba(221,126,113,0.5)]" />
                                        <img src={php} alt="php" className="w-8 sm:w-10 lg:w-12 hover:scale-125 transition-transform duration-300 cursor-pointer hover:drop-shadow-[0_0_8px_rgba(221,126,113,0.5)]" />
                                        <img src={mysql} alt="mysql" className="w-8 sm:w-10 lg:w-12 hover:scale-125 transition-transform duration-300 cursor-pointer hover:drop-shadow-[0_0_8px_rgba(221,126,113,0.5)]" />
                                        <img src={postgresql} alt="postgresql" className="w-8 sm:w-10 lg:w-12 hover:scale-125 transition-transform duration-300 cursor-pointer hover:drop-shadow-[0_0_8px_rgba(221,126,113,0.5)]" />
                                        <img src={git} alt="git" className="w-8 sm:w-10 lg:w-12 hover:scale-125 transition-transform duration-300 cursor-pointer hover:drop-shadow-[0_0_8px_rgba(221,126,113,0.5)]" />
                                        <img src={flutter} alt="flutter" className="w-8 sm:w-10 lg:w-12 hover:scale-125 transition-transform duration-300 cursor-pointer hover:drop-shadow-[0_0_8px_rgba(221,126,113,0.5)]" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div
                                ref={(el) => sectionsRef.current.push(el)}
                                className="what-i-do p-6 sm:p-8 rounded-[24px] bg-white/[0.02] border border-white/10 backdrop-blur-xl shadow-2xl transform hover:-translate-y-1 hover:border-secondary/20 transition-all duration-300 hover:shadow-secondary/5 flex flex-col justify-start"
                            >
                                <h2 className="font-avenir85Heavy text-2xl mb-6 text-white/90">What Can I Do?</h2>
                                <div className="space-y-4">
                                    {capabilities.map((item, index) => (
                                        <div key={index} className="flex gap-4 group">
                                            <div className="flex-shrink-0 mt-1 w-10 h-10 rounded-full bg-secondary/10 flex items-center justify-center group-hover:bg-secondary/20 transition-colors duration-300">
                                                {item.icon}
                                            </div>
                                            <div>
                                                <h3 className="font-sharpSemiBold25 text-base text-white/90 group-hover:text-secondary transition-colors duration-300">{item.title}</h3>
